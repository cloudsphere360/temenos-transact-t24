...
* EB.API>FF.B.CB.INT.CANCEL.REPORT
* EB.API>FF.B.CB.INT.CANCEL.REPORT.SELECT
* PGM.FILE>FF.B.CB.INT.CANCEL.REPORT
...
* 
* Description: Extract the CRB Report based on the between data Required field mapping
*-----------------------------------------------------------------------------*/
public class FfBCreditBurIntremCancelReport extends ServiceLifecycle {
    ...
    public List<String> getIds(ServiceData serviceData, List<String> controlList) {
        try {
            ...
            if ("RANGE".equalsIgnoreCase(cbrGen)) {
                ...
                dateOfAccountInformation = formatDateAsDdMMyyyy(fromDate);
            }
            ...
            List<String> arrIdClosedSe2 = da.selectRecords(finMnemonic, "EB.FF.LOAN.ACTIVITY", "",
                    "WITH ACTIVITY.TYPE EQ CANCELLATION AND UPDATE.DATE" + dateCondition);
            finalArrId.addAll(arrIdClosedSe2);
    ...
    public void process(String id, ServiceData serviceData, String controlItem) {
        try {
            ...
            if (cancelOpeningDate == null || cancelOpeningDate.trim().isEmpty()) {
                return;
            }
    ...
    private void getAccountRecord(String cancelAccountNo) {
        try {
            ...
            sanctionedDate = !ffSancDate.isEmpty() ? ffSancDate : cancelOpeningDate;
