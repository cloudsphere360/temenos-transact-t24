...
* EB.API>FF.B.CB.CANCEL.REPORT
*PGM.FILE>FF.B.CB.CANCEL.REPORT
*BATCH>BNK/FF.CB.CANCEL.REPORT
*BATCH>MFI/FF.CB.CANCEL.REPORT
*TSA.SERVICE>BNK/FF.CB.CANCEL.REPORT
*TSA.SERVICE>MFI/FF.CB.CANCEL.REPORT* 
*EB.FF.PARAMETER>FF.CBR.REPORT.PATH        --->For path
* 
* Description: Extract the CRB Report for full backup based on the Required field mapping
*-----------------------------------------------------------------------------*/
public class FfBCreditBureauCanceledReport extends ServiceLifecycle {
