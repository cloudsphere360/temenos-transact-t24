...
* EB.API>FF.B.CB.REPORT
* PGM.FILE>FF.B.CB.REPORT
...
*-----------------------------------------------------------------------------*/
public class FfBCreditBureauReport extends ServiceLifecycle {
    ...
    public void process(String id, ServiceData serviceData, String controlItem) {
        ...
        try {
            initialiseCompanyInfo(serviceData);
            reportedDate = determineReportedDate(todayDate);// 31 dec
            ...
            if ((aaArrStartDate.isBefore(lastDateOfMonth)) || (aaArrStartDate.equals(lastDateOfMonth))) {
    ...
    private void getCusDateOfBirth(String contractDate, String originalContractDate, CustomerRecord cusRec) {
        try {
            ...
            cusMaritalStatusType = cusRec.getMaritalStatus().getValue().toUpperCase();
