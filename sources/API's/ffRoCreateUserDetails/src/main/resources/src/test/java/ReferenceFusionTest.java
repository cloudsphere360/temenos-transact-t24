...
@Test
public void testffRoCreateUserDetails() {
  String requestName = "ffRoCreateUserDetails";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.ffRoCreateUserDetails", body, headers);
