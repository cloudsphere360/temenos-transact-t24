...
public class ProductFusionCollectionTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("product-fusionCollection.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testreverse() {
  String requestName = "reverse";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:product-fusionCollection.reverse", body, headers);
