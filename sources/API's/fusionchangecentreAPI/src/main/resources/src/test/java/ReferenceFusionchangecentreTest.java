...
public class ReferenceFusionchangecentreTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionchangecentre.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionchangecentre() {
  String requestName = "fusionchangecentre";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionchangecentre.fusionchangecentre", body, headers);
