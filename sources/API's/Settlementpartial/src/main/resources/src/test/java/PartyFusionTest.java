...
@Test
public void testfusionpartial() {
  String requestName = "fusionpartial";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-Fusion.fusionpartial", body, headers);
