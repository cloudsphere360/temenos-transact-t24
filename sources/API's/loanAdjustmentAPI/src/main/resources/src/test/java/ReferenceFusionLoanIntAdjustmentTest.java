...
public class ReferenceFusionLoanIntAdjustmentTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionLoanIntAdjustment.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testloanAdjustmentAPI() {
  String requestName = "loanAdjustmentAPI";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionLoanIntAdjustment.loanAdjustmentAPI", body, headers);
