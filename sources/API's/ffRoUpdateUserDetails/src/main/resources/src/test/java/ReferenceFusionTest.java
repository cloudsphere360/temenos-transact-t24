...
@Test
public void testffRoUpdateUserDetails() {
  String requestName = "ffRoUpdateUserDetails";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.ffRoUpdateUserDetails", body, headers);
