...
public class PartyEbffwrtchgoffactivityTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("party-ebffwrtchgoffactivity.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testwriteOffStatus() {
  String requestName = "writeOffStatus";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-ebffwrtchgoffactivity.writeOffStatus", body, headers);
