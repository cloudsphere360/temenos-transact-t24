...
public class ReferenceFusionLoanCancelTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionLoanCancel.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionLoanCancel() {
  String requestName = "fusionLoanCancel";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionLoanCancel.fusionLoanCancel", body, headers);
