...
public class PartyFusionTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("party-Fusion.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testAmortProceesingFees() {
  String requestName = "AmortProceesingFees";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-Fusion.AmortProceesingFees", body, headers);
