...
public class ReferenceFusionCollectionSheetTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionCollectionSheet.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionCollectionSheet() {
  String requestName = "fusionCollectionSheet";
...
headers.put("roEmployerId", "");
headers.put("bmEmployerId", "");
headers.put("demandDate", "");
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionCollectionSheet.fusionCollectionSheet", body, headers);
