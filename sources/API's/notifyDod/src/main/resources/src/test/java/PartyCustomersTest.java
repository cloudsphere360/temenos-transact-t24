...
@Test
public void testnotifyDod() {
  String requestName = "notifyDod";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-customers.notifyDod", body, headers);
