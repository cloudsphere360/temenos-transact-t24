...
@Test
public void testWaiveOffStatus() {
  String requestName = "WaiveOffStatus";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-Fusion.WaiveOffStatus", body, headers);
