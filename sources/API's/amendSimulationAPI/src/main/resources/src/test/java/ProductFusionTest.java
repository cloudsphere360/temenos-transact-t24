...
public class ProductFusionTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("product-fusion.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testamendSimulationAPI() {
  String requestName = "amendSimulationAPI";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:product-fusion.amendSimulationAPI", body, headers);
