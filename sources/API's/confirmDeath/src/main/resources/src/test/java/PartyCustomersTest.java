...
@Test
public void testupdateDeathStatus() {
  String requestName = "updateDeathStatus";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-customers.updateDeathStatus", body, headers);
