...
public class ReferenceFusionLucBmUpdateTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionLucBmUpdate.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionLucBmUpdate() {
  String requestName = "fusionLucBmUpdate";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionLucBmUpdate.fusionLucBmUpdate", body, headers);
