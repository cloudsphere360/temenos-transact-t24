...
public class ReferenceFusionLucRoUpdateTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionLucRoUpdate.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionLucRoUpdate() {
  String requestName = "fusionLucRoUpdate";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionLucRoUpdate.fusionLucRoUpdate", body, headers);
