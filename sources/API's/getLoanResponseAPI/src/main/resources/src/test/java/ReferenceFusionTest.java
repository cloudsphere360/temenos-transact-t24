...
@Test
public void testgetLoanResponseAPI() {
  String requestName = "getLoanResponseAPI";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.getLoanResponseAPI", body, headers);
