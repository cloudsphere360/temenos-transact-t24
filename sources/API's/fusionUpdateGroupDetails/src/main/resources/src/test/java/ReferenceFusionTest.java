...
@Test
public void testfusionUpdateGroupDetails() {
  String requestName = "fusionUpdateGroupDetails";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.fusionUpdateGroupDetails", body, headers);
