...
public class ProductCreateFusionSimulationTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("product-createFusionSimulation.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testcreateFusionSimulation() {
  String requestName = "createFusionSimulation";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:product-createFusionSimulation.createFusionSimulation", body, headers);
