...
public class ReferenceFusionFullChangeScheduleTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionFullChangeSchedule.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionFullChangeScheduleAPI() {
  String requestName = "fusionFullChangeScheduleAPI";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionFullChangeSchedule.fusionFullChangeScheduleAPI", body, headers);
