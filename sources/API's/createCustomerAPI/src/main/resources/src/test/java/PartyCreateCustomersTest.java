...
public class PartyCreateCustomersTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("party-createCustomers.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testcreateCustomerAPI() {
  String requestName = "createCustomerAPI";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-createCustomers.createCustomerAPI", body, headers);
