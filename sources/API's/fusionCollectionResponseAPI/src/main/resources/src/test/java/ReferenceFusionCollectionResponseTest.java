...
public class ReferenceFusionCollectionResponseTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionCollectionResponse.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionCollectionResponse() {
  String requestName = "fusionCollectionResponse";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionCollectionResponse.fusionCollectionResponse", body, headers);
