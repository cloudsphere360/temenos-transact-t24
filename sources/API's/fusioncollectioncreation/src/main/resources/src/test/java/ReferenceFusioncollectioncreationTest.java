...
public class ReferenceFusioncollectioncreationTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusioncollectioncreation.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusioncollectioncreation() {
  String requestName = "fusioncollectioncreation";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusioncollectioncreation.fusioncollectioncreation", body, headers);
