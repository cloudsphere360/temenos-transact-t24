...
@Test
public void testfusionCreateVillageDetails() {
  String requestName = "fusionCreateVillageDetails";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.fusionCreateVillageDetails", body, headers);
