...
public class ReferenceFusioncashcarryTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusioncashcarry.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusioncashcaryinput() {
  String requestName = "fusioncashcaryinput";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusioncashcarry.fusioncashcaryinput", body, headers);
