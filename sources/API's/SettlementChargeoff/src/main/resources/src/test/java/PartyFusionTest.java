...
@Test
public void testFusionchargeoff() {
  String requestName = "Fusionchargeoff";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-Fusion.Fusionchargeoff", body, headers);
