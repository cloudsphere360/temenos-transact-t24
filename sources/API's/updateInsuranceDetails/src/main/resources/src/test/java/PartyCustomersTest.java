...
public class PartyCustomersTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("party-customers.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testupdateInsuranceClaim() {
  String requestName = "updateInsuranceClaim";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-customers.updateInsuranceClaim", body, headers);
