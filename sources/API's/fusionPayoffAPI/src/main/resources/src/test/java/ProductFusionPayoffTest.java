...
public class ProductFusionPayoffTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("product-fusionPayoff.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionPayoffAPI() {
  String requestName = "fusionPayoffAPI";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:product-fusionPayoff.fusionPayoffAPI", body, headers);
