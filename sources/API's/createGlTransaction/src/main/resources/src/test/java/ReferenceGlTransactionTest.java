...
public class ReferenceGlTransactionTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-glTransaction.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-glTransaction.CREATE", body, headers);
