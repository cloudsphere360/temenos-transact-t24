...
public class PartyFusionCustLoanDetsTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("party-fusionCustLoanDets.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionCustLoanDetsAPI() {
  String requestName = "fusionCustLoanDetsAPI";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-fusionCustLoanDets.fusionCustLoanDetsAPI", body, headers);
