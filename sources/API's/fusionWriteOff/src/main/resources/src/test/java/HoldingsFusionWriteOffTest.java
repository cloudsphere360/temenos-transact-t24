...
public class HoldingsFusionWriteOffTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("holdings-fusionWriteOff.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionWriteOff() {
  String requestName = "fusionWriteOff";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:holdings-fusionWriteOff.fusionWriteOff", body, headers);
