...
public class ReferenceFusioncentrecreationTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusioncentrecreation.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusioncentrecreation() {
  String requestName = "fusioncentrecreation";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusioncentrecreation.fusioncentrecreation", body, headers);
