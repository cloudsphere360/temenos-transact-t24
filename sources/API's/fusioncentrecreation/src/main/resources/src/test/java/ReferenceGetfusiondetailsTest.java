...
public class ReferenceGetfusiondetailsTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-getfusiondetails.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testgetfusiondetails() {
  String requestName = "getfusiondetails";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-getfusiondetails.getfusiondetails", body, headers);
