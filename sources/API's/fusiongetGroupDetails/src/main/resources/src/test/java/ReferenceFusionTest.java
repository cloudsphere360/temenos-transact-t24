...
@Test
public void testfusiongetGroupDetails() {
  String requestName = "fusiongetGroupDetails";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.fusiongetGroupDetails", body, headers);
