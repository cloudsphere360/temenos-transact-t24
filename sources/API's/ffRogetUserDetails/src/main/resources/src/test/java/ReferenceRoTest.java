...
public class ReferenceRoTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-ro.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testffRogetUserDetails() {
  String requestName = "ffRogetUserDetails";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-ro.ffRogetUserDetails", body, headers);
