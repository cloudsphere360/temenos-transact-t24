...
@Test
public void testfusionUpdateVillageDetails() {
  String requestName = "fusionUpdateVillageDetails";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.fusionUpdateVillageDetails", body, headers);
