...
public class HoldingsCentreMeetingDetailsTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("holdings-centreMeetingDetails.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testcentreMeetingDetails() {
  String requestName = "centreMeetingDetails";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:holdings-centreMeetingDetails.centreMeetingDetails", body, headers);
