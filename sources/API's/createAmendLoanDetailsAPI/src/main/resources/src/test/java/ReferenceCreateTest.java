...
public class ReferenceCreateTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-create.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testcreateAmendLoanDetails() {
  String requestName = "createAmendLoanDetails";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-create.createAmendLoanDetails", body, headers);
