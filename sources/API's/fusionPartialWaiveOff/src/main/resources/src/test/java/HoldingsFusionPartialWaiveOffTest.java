...
public class HoldingsFusionPartialWaiveOffTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("holdings-fusionPartialWaiveOff.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionPartialWaiveOff() {
  String requestName = "fusionPartialWaiveOff";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:holdings-fusionPartialWaiveOff.fusionPartialWaiveOff", body, headers);
