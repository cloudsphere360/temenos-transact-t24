...
public class HoldingsFusionFullWaiveOffTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("holdings-fusionFullWaiveOff.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionFullWaiveOff() {
  String requestName = "fusionFullWaiveOff";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:holdings-fusionFullWaiveOff.fusionFullWaiveOff", body, headers);
