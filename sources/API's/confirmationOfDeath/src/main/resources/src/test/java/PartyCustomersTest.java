...
@Test
public void testconfirmationOfDeath() {
  String requestName = "confirmationOfDeath";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:party-customers.confirmationOfDeath", body, headers);
