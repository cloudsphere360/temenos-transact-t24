...
public class ReferenceFusionUserCreationTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("reference-fusionUserCreation.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testfusionUserCreationAPI() {
  String requestName = "fusionUserCreationAPI";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusionUserCreation.fusionUserCreationAPI", body, headers);
