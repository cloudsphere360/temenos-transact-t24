...
@Test
public void testgetVillageDetails() {
  String requestName = "getVillageDetails";
...
String body = "";
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:reference-fusion.getVillageDetails", body, headers);
