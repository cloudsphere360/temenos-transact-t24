...
public class ProductModifyFusionSimulationTest extends CamelRouteTest
{

 private static CamelUnitTestHelper helper;
@BeforeClass
public static void init() {
   helper = new CamelUnitTestHelper("product-modifyFusionSimulation.service.v1.0.0", "./src/test/resources/test-data/");
}
@Test
public void testmodifyFusionSimulation() {
  String requestName = "modifyFusionSimulation";
...
Object result = helper.getProducerTemplate().requestBodyAndHeaders("direct-vm:product-modifyFusionSimulation.modifyFusionSimulation", body, headers);
